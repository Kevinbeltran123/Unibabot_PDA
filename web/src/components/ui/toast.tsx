...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between gap-4 overflow-hidden rounded-lg border p-4 pr-6 shadow-lg transition-all animate-fade-in data-[state=open]:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
